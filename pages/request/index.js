                ...
                <div className="grid grid-col-6">
                  ...
                  <div className="col-start-1 col-span-3">
                    ...
                    <span className=" text-[#8E6947]">
                      {" "}
                      จันทร์ 27 มิถุนายน 2565 08.00 น.
                    </span>
                  </div>
                  <div className="col-start-4 col-span-4">
                    ...
                    <span className=" text-[#8E6947]">
                      {" "}
                      จันทร์ 27 มิถุนายน 2565 17.00 น.
                    </span>
                  </div>
                </div>
              </div>
