  ...
  return (
    <div>
      ...
      <div className="mx-auto  h-screen bg-cover overflow-hidden flex justify-center items-center align-middle bg-[#A17851]  max-w-screen-md">
        <div
          className="flex flex-col justify-center text-center xxl:w-1/3 xxl:h-5/6 xl:w-2/5 xl:h-5/6 lg:w-2/5 lg:h-5/6 md:w-3/5 md:h-3/4 sm:w-5/6 sm:h-5/6
        ...
        >
          ...
          <div className="mt-4 mb-0 grid grid-rows-3 gap-5 content-center mx-auto">
            <div
